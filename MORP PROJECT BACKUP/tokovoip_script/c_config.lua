TokoVoipConfig = {
	...
	radioClickMaxChannel = 0, -- Set the max amount of radio channels that will have local radio clicks enabled
	radioAnim = true, -- Enable or disable the radio animation
	radioEnabled = true, -- Enable or disable using the radio
	wsServer = "51.79.169.23:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "In-Game",
		TSPassword = "tokovoip123", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "MORP - Mallu Official Roleplay", -- TeamSpeak server address to be displayed on blocking screen
