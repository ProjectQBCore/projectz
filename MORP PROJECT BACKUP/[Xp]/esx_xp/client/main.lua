...
function ESXP_Add(XPAdd)
    ...
    Citizen.Wait(5000)
    TriggerEvent('BattlePass:AddXP', XPAdd)
end
...
RegisterNetEvent("esx_xp:boost1")
AddEventHandler("esx_xp:boost1", function(players)
    local xp1 = Config.xpb1
    exports.esx_xp:ESXP_Add(xp1)	
    ESX.ShowNotification('Awesome! You Got An XP Boost Of :- ' .. xp1)
end)

RegisterNetEvent("esx_xp:boost2")
AddEventHandler("esx_xp:boost2", function(players)
    local xp2 = Config.xpb2
    exports.esx_xp:ESXP_Add(xp2)	
    ESX.ShowNotification('Awesome! You Got An XP Boost Of :- ' .. xp2)
end)

RegisterNetEvent("esx_xp:boost3")
AddEventHandler("esx_xp:boost3", function(players)
    local xp3 = Config.xpb3
    exports.esx_xp:ESXP_Add(xp3)	
    ESX.ShowNotification('Awesome! You Got An XP Boost Of :- ' .. xp3)
end)

-- anim

RegisterNetEvent('esx_xp:Drink1')
AddEventHandler('esx_xp:Drink1', function(prop_name)
...
RegisterNetEvent('esx_xp:Drink2')
AddEventHandler('esx_xp:Drink2', function(prop_name)
	if not IsAnimated then
		prop_name = 'p_amb_bag_bottle_01'
		IsAnimated = true
...
RegisterNetEvent('esx_xp:Drink3')
AddEventHandler('esx_xp:Drink3', function(prop_name)
	if not IsAnimated then
