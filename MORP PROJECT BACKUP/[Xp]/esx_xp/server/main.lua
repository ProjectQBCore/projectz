...
ESX.RegisterUsableItem('boost1', function(source)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
    xPlayer.removeInventoryItem('boost1', 1)  --remove

	TriggerClientEvent('esx_xp:Drink1', source)  -- anim
	TriggerClientEvent('esx_xp:boost1', _source)  -- xp add
end)

ESX.RegisterUsableItem('boost2', function(source)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
    xPlayer.removeInventoryItem('boost2', 1)  --remove

	TriggerClientEvent('esx_xp:Drink2', source)  -- anim
	TriggerClientEvent('esx_xp:boost2', _source)  -- xp add
end)

ESX.RegisterUsableItem('boost3', function(source)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
    xPlayer.removeInventoryItem('boost3', 1)  --remove

	TriggerClientEvent('esx_xp:Drink3', source)  -- anim
	TriggerClientEvent('esx_xp:boost3', _source)  -- xp add
end)