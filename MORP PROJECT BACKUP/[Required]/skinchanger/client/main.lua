...
local Components = {
  ...
  {label = _U('chain_1'),               name = 'chain_1',       value = 0,  min = 0,  zoomOffset = 0.75,  camOffset = 0.15},
  {label = _U('chain_2'),               name = 'chain_2',       value = 0,  min = 0,  zoomOffset = 0.75,  camOffset = 0.15, textureof = 'chain_1'},
...
AddEventHandler('skinchanger:loadSkin', function(skin, cb)
  ...
  if skin ~= nil and skin['sex'] ~= LastSex then
