...
Config.SafeHouseCostBandito = 500
...
Config.SafeVehicleSpawnRadius = 50.0
...
{id = 1, id2 = 1, Weapon= 0x13532244, Vehicle = "barrage", modelHash = "u_m_y_zombie_01",  x = 1205.98, y = 3116.36, z = 40.41, heading = 279.76,notzed=true,target=true,SetBlockingOfNonTemporaryEvents=true}, --movetocoord={ x = 1453.72, y = -2282.69, z = 67.47},
...
{id = 9, id2 = 9, Weapon= 0x13532244, Vehicle = "technical3", modelHash = "u_m_y_zombie_01",  x = 1718.96, y = 3258.17, z = 41.13, heading = 284.77 , notzed=true,target=true,SetBlockingOfNonTemporaryEvents=true},
		...
		{id = 11, id2 = 11, Weapon= 0x13532244, Vehicle = "dune3", modelHash = "u_m_y_zombie_01",x = 1443.97, y = 3190.27, z = 40.45, heading = 281.69, notzed=true,target=true,SetBlockingOfNonTemporaryEvents=true},
...
StartMessage = "Ensure that the asset and their plane~n~ make it to the destination~n~~r~Hurry!",
   ...
   IsDefendTargetGoalDistance=100.0,
	...
	Vehicles = { 
		--{id = 1, outside=true, Vehicle = "rhino", modelHash = "s_m_y_ammucity_01", x = -203.92, y = -1096.21, z = 21.16, heading = 143.9},
...
Events = {
  ...
  Mission39 = {
	...
	Events = {
		...
		{ 
		  Type="Vehicle",
		  Position = { x = -77.12, y = -825.71, z = 321.29, heading = 254.97 }, 
		  Size     = {radius=5.0},
		  SpawnHeight = 400.0,
		  FacePlayer = true,
		  SpawnAt = { x = -90.25, y = -840.43, z = 302.35, heading = 148.62  }, 
		  --NumberPeds=10,
		  isBoss=false,
		  Target=false,
		  Vehicle="maverick",
		...
		{ 
		  ...
		  SpawnHeight = 400.0,
		  FacePlayer = true,
		  SpawnAt = { x = -65.07, y = -790.91, z = 302.32, heading = 340.15 }, 
		  --NumberPeds=10,
		  isBoss=false,
		  Target=false,
		  Vehicle="valkyrie",
	...
	VehicleGotoMissionTargetVehicle=1,
	--VehicleGotoMissionTargetPed=16,
    Vehicles = {
		--maze bank
		{id = 1, id2 = 1, Weapon= 0x2BE6766B, Vehicle = "trailersmall", modelHash = "s_m_y_ammucity_01", x = -76.06, y = -820.3, z = 326.18, heading = 377.86,Freeze=true,notvisible=true,outside=true,},
		 {id = 2, id2 = 2, Vehicle = "akula", modelHash = "s_m_y_ammucity_01", x = -75.06, y = -819.3, z = 326.18+60, heading = 377.86, heading = 377.86, Weapon=0x13532244,driving=true,outside=true,pilot=true, isAircraft=true,VehicleGotoMissionTarget=true,VehicleGotoMissionTargetVehicle=1,SetBlockingOfNonTemporaryEvents=true},
		 --SUBMARINE
...
StartMessage = "Ensure that the asset and their helicopter~n~ make it to the destination~n~~r~Hurry!",
	FinishMessage = "Mission Completed!",
	MissionTitle = "Get to the Choppa!",
	MissionMessage = "New Mission",	
	...
	StartMessageObj = "Capture the objective!",
	FinishMessageObj = "Mission Completed!",
	MissionTitleObj = "Get to the Choppa!",
	MissionMessageObj = "Capture the objective!",	
	
	StartMessageAss = "Ensure that the asset and their helicopter~n~ make it to the destination~n~~r~Hurry!",
	FinishMessageAss = "Mission Completed!",
	MissionTitleAss = "Get to the Choppa!",
	MissionMessageAss = "Ensure that the asset and their helicopter~n~ make it to the destination",		
	Type = "Assassinate",	
	IsRandom = true,
	RandomMissionTypes ={"Assassinate"},
	IsDefend = true,
...
Events = {
    ...
    {id = 2, 
		Position = {x = 1585.8, y = 3175.95, z = 40.53, heading = 159.45  },
	  	  Type="Aircraft",
		  Size     = {radius=1000.0},
		  SpawnHeight = 200.0,
		  FacePlayer = true,
	...
	SMS_Subject="Escort Mission",
	SMS_Message="We need help to ensure that an asset and their helicopter make it to the destination",
	SMS_Message2="They will need an escort. Are you up for this?",
	--SMS_Message3="Anyone up for this?",	
	...
	{  x = 1318.13, y = 3624.67, z = 33.5,  MissionTitle="Get to the Choppa!",
		Blip2 = { --safehouse blip
		  Title = "Mission Start: Rendevouz with the asset",
		  Position = { x = 1515.16, y = 3064.27, z = 41.3}, -- x = 2365.07, y = 2958.56, z = 49.06 --{ x = 1944.96, y = 3150.6, z = 46.77}, --x = 1345.43, y = 3152.51, z = 40.41
		  Icon     = 58,
...
StartMessage = "Fly the asset and their helicopter~n~ to the destination~n~~r~Hurry!",
	FinishMessage = "Mission Completed!",
	MissionTitle = "Get to the Choppa! v2",
	MissionMessage = "New Mission",	
	...
	StartMessageObj = "Capture the objective!",
	FinishMessageObj = "Mission Completed!",
	MissionTitleObj = "Get to the Choppa! v2",
	MissionMessageObj = "Capture the objective!",	
	
	StartMessageAss = "Fly the asset and their helicopter~n~ to the destination~n~~r~Hurry!",
	FinishMessageAss = "Mission Completed!",
	MissionTitleAss = "Get to the Choppa! v2",
	MissionMessageAss = "Fly the asset and their helicopter~n~ to the destination~n~~r~Hurry!",		
	Type = "Assassinate",	
	IsRandom = true,
	RandomMissionTypes ={"Assassinate"},
	IsDefend = true,
	...
	UseSafeHouseLocations = false,
	IsDefendTargetPassenger=true,
	--IsDefendTargetPassengerSeatId=2,
	IsDefendTargetGoalDistance=100.0,
	--RandomMissionDoBoats = true,
	MissionTriggerRadius = 20.0,
	MissionTriggerStartPoint = { x = 1515.16, y = 3064.27, z = 41.3},
...
Events = {
	...
	{  x = 1318.13, y = 3624.67, z = 33.5,  MissionTitle="Get to the Choppa! v2",
		Blip2 = { --safehouse blip
		  Title = "Mission Start: Rendevouz with the asset",
		  Position = { x = 1515.16, y = 3064.27, z = 41.3}, -- x = 2365.07, y = 2958.56, z = 49.06 --{ x = 1944.96, y = 3150.6, z = 46.77}, --x = 1345.43, y = 3152.51, z = 40.41
		  Icon     = 58,
...
Mission53 = {
    ...
    StartMessage = "Reclaim the missing cargo from the shot down cargo plane",
	FinishMessage = "Mission Completed!",
	...
	SMS_Message3="Paradrop into the location and search Vinewood Hills for the 9 missing crates and secure them",	
	...
	SafeHousePedDoctors = {},
	SafeHousePedLeaders = {},
	MissionTriggerStartPoint = {x = -792.96, y = 1849.24, z = 1168.61},
	MissionTriggerRadius = 10.0,
	--RandomMissionBossPeds = {"s_m_y_autopsy_01"},
	--RandomMissionPeds = {"s_m_y_autopsy_01"},
	--HostileAmbientPeds = 3,
   ...
   -- },
		BlipS = { --safehouse blip 
		  Title = "Mission Paradrop",
		  Position = { x = -792.96, y = 1849.24, z = 169.61}, --{ x = 1944.96, y = 3150.6, z = 46.77},
		  Icon     = 417,
		  Display  = 4,
		  Size     = 1.2,
		  Color    = 2,
		 ...
		 MarkerS = { --safehouse marker
		  Type     = 1,
		  Position = { x = -792.96, y = 1849.24, z = 1168.61},  --{  x = 1944.96, y = 3150.6, z = 46.77}, 
		  Size     = {x = 2.0, y = 2.0, z = 2.0},
		  Color    = {r = 117, g = 218, b = 255},
		  DrawDistance = 200.0,
		},
	...
	Props = {
		...
		{ id=1,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -1781.89, y = 263.09, z = 72.16, heading = 291.06 }},
		{ id=2,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -1798.66, y = 362.18, z = 88.56, heading = 9.83 }},
		{ id=3,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -1678.94, y = 503.89, z = 128.31, heading = 128.29 }},	
		{ id=4,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -1260.24, y = 567.96, z = 116.15, heading = 227.76}},
		{ id=5,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -793.14, y = 523.57, z = 106.02, heading = 235.72}},
		{ id=6,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = { x = -747.0, y = 753.74, z = 192.62, heading = 193.97}},	
		{ id=7,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = {x = -450.42, y = 468.52, z = 111.2, heading = 417.96 }},	
		{ id=8,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = {x = -212.08, y = 731.11, z = 199.06, heading = 219.18}},
		{ id=9,  Name = "hei_prop_carrier_bombs_1",isObjective=true, Position = {x = -1606.61, y = 367.36, z = 81.26, heading = 154.13}},
	...
	Events = {
		...
		{ --Dam bottom
		  Type="Squad",
		  Position = { x = -1781.89, y = 263.09, z = 72.16, heading = 291.06 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		  ...
		  CheckGroundZ=true,
				...
				{ --Dam bottom
		  Type="Squad",
		  Position = {x = -1798.66, y = 362.18, z = 88.56, heading = 9.83 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		 ...
		 -- modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -1678.94, y = 503.89, z = 128.31, heading = 128.29  }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		 NumberPeds=2,
		 ...
		 -- modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -1260.24, y = 567.96, z = 116.15, heading = 227.76 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		...
		--  modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -793.14, y = 523.57, z = 106.02, heading = 235.72 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		 ...
		 -- modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -747.0, y = 753.74, z = 192.62, heading = 193.97 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		 ...
		 -- modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -450.42, y = 468.52, z = 111.2, heading = 417.96 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
		 ...
		 -- modelHash="u_m_y_zombie_01",
		  ...
		  CheckGroundZ=true,
			...
			{ --Dam bottom
		  Type="Squad",
		  Position = {x = -212.08, y = 731.11, z = 199.06, heading = 219.18 }, 
		  Size     = {radius=100.0},
		  SpawnHeight = 200.0,
		  --FacePlayer = true,
		  NumberPeds=2,
	...
	{ --Dam bottom
		...
		{Type="Vehicle",
		  Position = { x = -1433.4, y = 525.94, z = 118.69, heading = 350.69,}, 
		  Size     = {radius=400.0},
		  SpawnHeight =300.0,
		  --FacePlayer = true,
		  --NumberPeds=10,
		...
		{Type="Vehicle",
		  Position = {x = -698.58, y = 496.44, z = 109.45, heading = 202.2,}, 
		  Size     = {radius=400.0},
		  SpawnHeight =300.0,
		 -- FacePlayer = true,
		  --NumberPeds=10,
		...
		{Type="Vehicle",
		  Position = {x = -667.34, y = 817.64, z = 200.93, heading = 131.96,}, 
		  Size     = {radius=400.0},
		  SpawnHeight =300.0,
		  --FacePlayer = true,
		  --NumberPeds=10,
		...
		{Type="Vehicle",
		  Position = {x = -336.58, y = 486.12, z = 112.66, heading = 111.63,}, 
		  Size     = {radius=400.0},
		  SpawnHeight =300.0,
		  --FacePlayer = true,
		  --NumberPeds=10,
		...
		{Type="Vehicle",
		  Position = {x = -1777.29, y = 225.77, z = 68.51, heading = 316.14,}, 
		  Size     = {radius=400.0},
		  SpawnHeight =300.0,
		  --FacePlayer = true,
		  --NumberPeds=10,
    ...
    Vehicles = {
	  ...
	  {id = 1, id2 = 1, Weapon = 0x687652CE, Vehicle = "cargoplane", modelHash = "S_M_M_ChemSec_01", x = -802.75, y = 1835.3, z = 1166.08, heading = 324.69 ,Freeze=true,OpenDoorNum=2,driving=true,isAircraft=true,friendly=true,noFill=true,useDefaultHeading=true,vehicleinvincible=true},
	   ...
	   {id = 4, id2 = 4, Weapon= 0x2BE6766B, Vehicle = "valkyrie", modelHash = "s_m_y_ammucity_01",   x = 0.0, y = -4000.58, z = 142.35, heading = 184.52, driving=true,isAircraft=true,VehicleGotoMissionTarget=true,VehicleGotoMissionTargetVehicle=3,SetBlockingOfNonTemporaryEvents=true,},
	    {id = 5, id2 = 5, Weapon= 0x2BE6766B, Vehicle = "tula", modelHash = "s_m_y_ammucity_01",   x = 216.18, y = -4000.58, z = 142.35, heading = 184.52, driving=true,isAircraft=true,VehicleGotoMissionTarget=true,VehicleGotoMissionTargetVehicle=3,SetBlockingOfNonTemporaryEvents=true,},
	  --{id = 3, id2 = 3, Vehicle = "valkyrie", modelHash = "S_M_M_ChemSec_01",  x = -1166.42, y = 4641.5, z = 165.11, heading = 210.07,driving=true,pilot=true,isAircraft=true,VehicleGotoMissionTarget=true,SetBlockingOfNonTemporaryEvents=true,},
	 -- {id = 2, id2 = 2, Vehicle = "toro2", modelHash = "s_m_y_ammucity_01",  x = -3014.83, y = -43.5, z = 0.13, heading = 151.19, driving=true},
    }
  } , 
...
StartMessage = "Escort the asset and their plane across San Andreas~n~to the destination ~r~Hurry!",
	FinishMessage = "Mission Completed!",
	MissionTitle = "Top Gun",
	MissionMessage = "New Mission",	
	...
	StartMessageAss = "Escort the asset and their plane across San Andreas~n~to the destination ~r~Hurry!",
	FinishMessageAss = "Mission Completed!",
	MissionTitleAss = "Top Gun",
	MissionMessageAss = "Escort the asset and their plane across San Andreas~n~to the destination ~r~Hurry!",		
	Type = "Assassinate",	
	IsRandom = true,
	RandomMissionTypes ={"Assassinate"},
	IsDefend = true,
...
---how many extra event areas are there in the mission?
	...
	Peds = {
	 ...
	 IndoorsMission=true,
	Vehicles = { 
		{id = 1, outside=true, Vehicle = "hydra", modelHash = "s_m_y_ammucity_01",x = 3106.08, y = -4818.02, z = 15.26, heading = 23.12},
			{id = 2, outside=true, Vehicle = "lazer", modelHash = "s_m_y_ammucity_01", x = 3062.85, y = -4683.86, z = 15.77, heading = 2.55},
			{id = 3, outside=true, Vehicle =  "pyro", modelHash = "s_m_y_ammucity_01", x = 3070.29, y = -4797.68, z = 15.26, heading = 8.03 },
	{id = 4, outside=true, Vehicle = "lazer", modelHash = "s_m_y_ammucity_01",x = 3084.73, y = -4675.04, z = 15.26, heading = 55.81},
	{id = 5, outside=true, Vehicle = "rogue", modelHash = "s_m_y_ammucity_01", x = 3101.01, y = -4743.88, z = 15.26, heading = 94.98},
	{id = 6, outside=true, Vehicle = "starling", modelHash = "s_m_y_ammucity_01",x = 3109.67, y = -4756.21, z = 15.26, heading = 101.85},
	{id = 7, outside=true, Vehicle = "hydra", modelHash = "s_m_y_ammucity_01",x = 3044.01, y = -4741.49, z = 15.26, heading = 11.25},
	{id = 8, outside=true, Vehicle = "lazer", modelHash = "s_m_y_ammucity_01",x = 3119.01, y = -4786.79, z = 15.26, heading = 96.94 },
	{id = 9, outside=true, Vehicle = "pyro", modelHash = "s_m_y_ammucity_01",x = 3083.71, y = -4821.93, z = 15.26, heading = 288.34},
	{id = 10, outside=true, Vehicle = "nokota", modelHash = "s_m_y_ammucity_01",x = 3049.68, y = -4768.78, z = 15.26, heading = 291.26},
	{id = 11, outside=true, Vehicle = "molotok", modelHash = "s_m_y_ammucity_01",x = 3044.94, y = -4758.35, z = 15.26, heading = 287.08},
	{id = 12, outside=true, Vehicle = "hydra", modelHash = "s_m_y_ammucity_01",x = 3037.83, y = -4714.42, z = 15.26, heading = 14.01 },
	...
	{  x = 1318.13, y = 3624.67, z = 33.5,  MissionTitle="The Long Shot",
		Blip2 = { --safehouse blip
		  Title = "Mission Start: Rendevouz with the asset",
...
StartMessage = "Fly the asset across San Andreas~n~to the destination ~r~Hurry!",
	...
	FinishMessageAss = "Mission Completed!",
	MissionTitleAss = "The Long Shot v2",
...
---how many extra event areas are there in the mission?
	...
	{  x = 1318.13, y = 3624.67, z = 33.5,  MissionTitle="The Long Shot v2",
		Blip2 = { --safehouse blip
		  Title = "Mission Start: Rendevouz with the asset",
