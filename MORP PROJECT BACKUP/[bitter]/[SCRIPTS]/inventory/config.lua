...
-- Version / Important
Config.PlayerWeight = false -- only works if you are using ESX 1.2 and above.
...
Config.CloseOnUse = {"craftingbook", "", ""} -- all items in this array will close the inventory when used
...
Config.SoundEffects = false -- toggle sound effects on/off
...
Config.DirtyCash = false -- toggle dirty cash on/off (put your black_money `id` here from esx or put `false` if you dont want dirty cash)
