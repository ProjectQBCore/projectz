    ...
    function(item, unmarked)
        ...
        if item == "pistol_clip" then
            if getWeaponType(selectedWeapon) == "pistol" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 250 then -- < GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 12)--GetWeaponClipSize(selectedWeapon))
        ...
        elseif item == "rifle_clip" then
            if getWeaponType(selectedWeapon) == "assault" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 250 then --GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 30)--GetWeaponClipSize(selectedWeapon))
        ...
        elseif item == "lightsmg_clip" then
            if getWeaponType(selectedWeapon) == "lightmachine" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 250 then-- GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 50)-- GetWeaponClipSize(selectedWeapon))
        ...
        elseif item == "shotgun_clip" then
            if getWeaponType(selectedWeapon) == "shotgun" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 120 then -- GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 8)--GetWeaponClipSize(selectedWeapon))
        ...
        elseif item == "sniper_clip" then
            if getWeaponType(selectedWeapon) == "sniper" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 200 then -- GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 10)--GetWeaponClipSize(selectedWeapon))
        ...
        elseif item == "smg_clip" then
            if getWeaponType(selectedWeapon) == "submachine" then
                if GetAmmoInPedWeapon(ped, selectedWeapon) <= 200 then --GetWeaponClipSize(selectedWeapon) then
                    SetPedAmmo(ped, selectedWeapon, GetAmmoInPedWeapon(ped, selectedWeapon) + 25)--GetWeaponClipSize(selectedWeapon))
