...
RegisterNetEvent('pogressBar2:drawBar')
AddEventHandler('pogressBar2:drawBar', function(time, text, cb, options)
...
Citizen.CreateThread(function()
	...
	TriggerEvent('pogressBar2:drawBar', 1000, 'test', function()
		print('callback Test')
	end)
