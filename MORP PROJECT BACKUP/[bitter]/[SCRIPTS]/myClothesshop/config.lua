...
Config.NormalShopPed = "Bf4RusAssault"
Config.HATersShopPed = "BF4RusSniper"
Config.MaskShopPed   = "BF4RusSupport"

Config.NormalBlipColour = 4

Config.Shops = { 
    {type = 'CLOTH SHOP', x = -1119.78, y = 4959.66, z = 220.38, rot = 346.64},
    {type = 'HAT', x = -1115.94, y = 4959.13, z = 220.38, rot = 60.55},
	  {type = 'MASK', x = -1117.19, y = 4954.66, z = 220.38, rot = 0.68},
}
...
Translation = {
  ...
  ['en'] = {
    ...
    ['outfit_remove'] = 'Remove this outfit from the list ?',
