...
WearRate = 10000, -- The rate parts wear off (Higher the value less wear on the parts)
UseMiles = false, -- If set to false it will use kilometers
UseRelativeValues = true, --on akiya vandi oodi povum -- If set to true cars performance wouldnt be affected with stock parts. Otherwise stock car parts will make the car slower
...
['stock_engine'] = {
        ...
        sound = "DEFAULT",
        repair = {
            ['scrap'] = {amount = 10, reusable = false},
        }
}, 
