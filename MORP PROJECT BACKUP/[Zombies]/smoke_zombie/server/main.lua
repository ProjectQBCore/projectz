...
RegisterServerEvent("smoke_zombie:newplayer")
AddEventHandler("smoke_zombie:newplayer", function(id)
    players[source] = id
    TriggerClientEvent("smoke_zombie:playerupdate", -1, players)
end)

AddEventHandler("playerDropped", function(reason)
    players[source] = nil
    TriggerClientEvent("smoke_zombie:clear", source)
    TriggerClientEvent("smoke_zombie:playerupdate", -1, players)
end)

AddEventHandler("onResourceStop", function()
	 TriggerClientEvent("smoke_zombie:clear", -1)
end)

RegisterServerEvent('smoke_zombie:moneyloot')
AddEventHandler('smoke_zombie:moneyloot', function(amount)
...
RegisterServerEvent('smoke_zombie:itemloot')
AddEventHandler('smoke_zombie:itemloot', function(item)
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent("smoke_zombie:rank")
AddEventHandler("smoke_zombie:rank", function(id)
    print(id)
end)
