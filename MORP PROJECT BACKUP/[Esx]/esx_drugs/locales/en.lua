Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~wheat~s~ plant.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~g~wheat~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process wheat~s~.',
  ['weed_processingstarted'] = 'processing ~g~wheat~s~ into ~g~Marijuana~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~wheat~s~ in order to process.',
  ['weed_processed'] = 'you\'ve processed ~b~3x~s~ ~g~wheat~s~ to ~b~1x~s~ ~g~Marijuana~s~',
  ['weed_processingtoofar'] = 'the processing has been ~r~canceled~s~ due to you abandoning the area.',

  -- drug dealer
  ['dealer_prompt'] = 'press ~INPUT_CONTEXT~ to talk with the ~r~Trader~s~.',
  ['dealer_title'] = 'Trader',
  ['dealer_item'] = '$%s',
