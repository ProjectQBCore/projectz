...
Config.EarlyRespawnTimer          = 2 * second  -- Time til respawn is available 2 = 1 min - 1 = 30s --old udayipp
...
Config.RespawnPoint = { coords = vector3(-1170.35,4926.56,224.40), heading = 264.15 }
