...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = _U('pharmacy_take', _U('syringe')), item = 'syringe', type = 'slider', value = 1, min = 1, max = 100},
...
AddEventHandler('esx_ambulancejob:heal', function(healType)
	...
	elseif healType == 'big' then
		if health <= 150 then 
			...
			ESX.ShowNotification('You Wasted A Medkit!')
		end
	elseif healType == 'lite' then -- syringe
