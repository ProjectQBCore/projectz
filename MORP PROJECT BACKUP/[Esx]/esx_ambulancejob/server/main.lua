...
AddEventHandler('esx_ambulancejob:removeItem', function(item)
	...
	elseif item == 'syringe' then 
		xPlayer.showNotification(_U('used_syringe'))
	end
end)
...
AddEventHandler('esx_ambulancejob:giveItem', function(itemName, amount)
	...
	if xPlayer.job.name ~= 'ambulance' then
		...
		return
	elseif (itemName ~= 'medikit' and itemName ~= 'bandage' and itemName ~= 'syringe') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
...
ESX.RegisterUsableItem('syringe', function(source)
	...
	TriggerClientEvent('esx_ambulancejob:heal', _source, 'lite')
	TriggerClientEvent('esx:showNotification', _source, _U('used_syringe'))
end)
