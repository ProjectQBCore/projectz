...
local settings = {
    discord = {
        guildId = "731079395548201000",
		botToken = "NzQzMzI2NjQ1NjUzMzQwMTgw.XzTC4g.yhyiKL52UNDm3GNx1hHdtM7jcyA",
    }
}
    ...
    PerformHttpRequest("https://discordapp.com/api/guilds/" .. settings.discord.guildId .. "/members/"..string.sub(discord, 9), function(err, text, headers)
        if err == 200 then
            ...
            if member.user.avatar then
                data["avatar"] = "https://cdn.discordapp.com/avatars/"..member.user.id.."/"..member.user.avatar..".png?size=128"
            else
                data["avatar"] = "https://cdn.discordapp.com/attachments/713049735824670893/836966635713200138/logo.png"
            end
        else 
