...
-- server Add Whitelist Command (Supports Ace)
RegisterCommand("addw", function(source, args, rawCommand)
    addToWhitelist(args, "", true)
end, true)

-- server Remove Whitelist Command (Supports Ace)
RegisterCommand("removew", function(source, args, rawCommand)
    removeFromWhitelist(args, "", true)
end, true)

-- server Reload Whitelist Command (Supports Ace)
RegisterCommand("reloadw", function(source, args, rawCommand)
    for i = 0, #Whitelist do
        Whitelist[i] = nil
    end
