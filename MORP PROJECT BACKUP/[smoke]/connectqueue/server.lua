Config.DiscordBotToken = "NzQzMzI2NjQ1NjUzMzQwMTgw.XzTC4g.yhyiKL52UNDm3GNx1hHdtM7jcyA" -- Discord Bot Token. You can create one on https://discord.com/developers/applications
Config.maxServerSlots = 1024
